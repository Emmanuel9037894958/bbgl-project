...
export default function LeadershipPage() {
  return (
    <main className="bg-white text-slate-900">
        ...
        <div className="bbgl-container relative z-10 flex min-h-[620px] items-end pb-14 sm:min-h-[680px] sm:pb-20 lg:min-h-[740px]">
          ...
          <div className="max-w-4xl">
            ...
            <div className="mt-8 flex flex-wrap gap-4">
              ...
              <Link
                href="/about"
                className="inline-flex items-center gap-2 border border-white/40 bg-white px-6 py-3.5 text-sm font-semibold text-white backdrop-blur-sm transition hover:bg-white hover:text-[#071a2d]"
              >
                About BBGL
      ...
      <section
        id="executives"
        className="bg-[#f7f9fb] py-5 sm:py-24 lg:py-28"
      >
