  ...
  return (
    <section className="relative min-h-[calc(100svh-117px)] overflow-hidden bg-[#071a2d] py-6">
      ...
      <div className="absolute inset-0 z-0">
        ...
        {/* DARK OVERLAY */}
        <div className="absolute inset-0 bg-[#020b12]/5" />

        {/* LEFT-SIDE GRADIENT FOR TEXT READABILITY */}
        <div className="absolute inset-0 bg-gradient-to-r from-[#020b14]/90 via-[#071a2d]/65 to-[#071a2d]/25" />

        {/* BOTTOM GRADIENT */}
        <div className="absolute inset-x-0 bottom-0 h-40 bg-gradient-to-t from-[#020b14]/60 to-transparent" />
      </div>
        ...
        <div className="grid min-h-[calc(100svh-117px)] items-center py-12 sm:py-16 lg:py-20">
          ...
          <div className="max-w-[720px]">
            ...
            <p className="mt-5 max-w-[620px] text-sm leading-7 text-slate-200 sm:mt-6 sm:text-base sm:leading-8">
              ...
              with interests across multiple sectors, building businesses with
              a long-term vision and one excellent standard.
            </p>
            ...
            <div className="mt-7 flex w-full flex-row gap-2.5 sm:mt-8 sm:w-auto sm:gap-3">
              ...
              <Link
                href="/about"
                className="inline-flex min-h-[49px] flex-1 items-center justify-center rounded-md border border-white/30 bg-white px-3 text-[11px] font-bold text-white backdrop-blur-sm transition-all duration-200 hover:border-white/50 hover:bg-white/20 sm:min-h-[54px] sm:flex-none sm:px-7 sm:text-sm"
              >
                About BBGL
              </Link>
            </div>
      ...
      {/* VIDEO STATUS / DECORATIVE ELEMENT */}
