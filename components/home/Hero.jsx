        ...
        <div className="grid min-h-[calc(100svh-117px)] items-center py-12 sm:py-16 lg:py-20">
          ...
          <div className="max-w-[720px]">
            ...
            <div className="mt-7 flex w-full flex-row gap-2.5 sm:mt-8 sm:w-auto sm:gap-3">
              ...
              <Link
                href="/about"
                className="inline-flex min-h-[49px] flex-1 items-center justify-center rounded-md border border-white bg-white/10 px-3 text-[11px] font-bold text-white backdrop-blur-sm transition-all duration-200 hover:bg-white sm:min-h-[54px] sm:flex-none sm:px-7 sm:text-sm"
              >
                About BBGL
              </Link>
